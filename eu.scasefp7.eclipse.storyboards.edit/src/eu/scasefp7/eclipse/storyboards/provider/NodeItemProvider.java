...
public class NodeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_annotations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_annotations_feature", "_UI_Node_type"),
				 StoryboardsPackage.Literals.NODE__ANNOTATIONS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Node)object).getAnnotations();

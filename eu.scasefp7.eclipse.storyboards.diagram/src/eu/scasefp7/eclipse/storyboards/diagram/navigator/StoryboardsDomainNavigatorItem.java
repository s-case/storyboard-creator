	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof eu.scasefp7.eclipse.storyboards.diagram.navigator.StoryboardsDomainNavigatorItem) {
					eu.scasefp7.eclipse.storyboards.diagram.navigator.StoryboardsDomainNavigatorItem domainNavigatorItem = (eu.scasefp7.eclipse.storyboards.diagram.navigator.StoryboardsDomainNavigatorItem) adaptableObject;
		...
		}, eu.scasefp7.eclipse.storyboards.diagram.navigator.StoryboardsDomainNavigatorItem.class);
	}

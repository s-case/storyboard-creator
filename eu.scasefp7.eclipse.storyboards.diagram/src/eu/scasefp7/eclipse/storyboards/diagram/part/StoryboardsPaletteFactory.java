...
public class StoryboardsPaletteFactory {
	...
	private ToolEntry createStoryboard1CreationTool() {
		...
		entry.setSmallIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj16/Storyboard.gif")); //$NON-NLS-1$
		entry.setLargeIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj32/Storyboard.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createProperty2CreationTool() {
		...
		entry.setSmallIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj16/Property.gif")); //$NON-NLS-1$
		entry.setLargeIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj32/Property.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createAction3CreationTool() {
		...
		entry.setSmallIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj16/Action.gif")); //$NON-NLS-1$
		entry.setLargeIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj32/Action.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createPath4CreationTool() {
		...
		entry.setSmallIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj16/Path.gif")); //$NON-NLS-1$
		entry.setLargeIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj32/Path.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createCondition5CreationTool() {
		...
		entry.setSmallIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj16/Condition.gif")); //$NON-NLS-1$
		entry.setLargeIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj32/Condition.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createStartNode6CreationTool() {
		...
		entry.setSmallIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj16/StartNode.gif")); //$NON-NLS-1$
		entry.setLargeIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj32/StartNode.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEndNode7CreationTool() {
		...
		entry.setSmallIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj16/EndNode.gif")); //$NON-NLS-1$
		entry.setLargeIcon(StoryboardsDiagramEditorPlugin
				.findImageDescriptor("/eu.scasefp7.eclipse.storyboards.edit/icons/full/obj32/EndNode.gif")); //$NON-NLS-1$
		return entry;
	}
}
